...
namespace SnmpSharpNet
{
    ...
    {
        /// <summary>Get SNMP version number.</summary>
        ESnmpVersion Version { get; }

        /// <summary>Check validity of the agent properties object.</summary>
        /// <returns>true if object has all the information needed, otherwise false.</returns>
        bool Valid();

        /// <summary>Initialize SNMP packet class with values contained in this class.</summary>
