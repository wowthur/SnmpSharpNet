...
namespace SnmpSharpNet.Security
{
    ...
    public sealed class Authentication
    {
        ...
        /// </summary>
        /// <param name="authenticationProtocol">Authentication protocol code. Available codes are <see cref="AuthenticationDigests.MD5"/>,
        ...
        public static IAuthenticationDigest GetInstance(AuthenticationDigests authenticationProtocol)
        {
