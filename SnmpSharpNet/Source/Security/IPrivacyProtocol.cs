...
{
    /// <summary>Privacy protocol interface.</summary>
    /// <remarks>
    ...
    public interface IPrivacyProtocol
    {
        ...
        /// <summary>Get minimum acceptable encryption/decryption key length for the protocol.</summary>
        int MinimumKeyLength { get; }

        /// <summary>Get maximum acceptable encryption/decryption key length for the protocol.</summary>
        ...
        /// <summary>Returns true if derived class supports key extension, otherwise false.</summary>
