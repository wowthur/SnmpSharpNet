...
namespace SnmpSharpNet.Security
{
    ...
    public class PrivacyDES : IPrivacyProtocol
    {
        ...
        public PrivacyDES()
        {
            ...
            salt = random.Next(1, int.MaxValue);
        }
        ...
        /// <summary>Decrypt DES encrypted ScopedPdu</summary>
        ...
        /// <summary>Returns minimum encryption/decryption key length. For DES, returned value is 16.</summary>
        /// <remarks>
        ...
        /// <summary>Return maximum encryption/decryption key length. For DES, returned value is 16</summary>
        /// <remarks>
        /// DES protocol requires an 8 byte encryption key and additional 8 bytes are used for generating the
        /// encryption IV.
        /// </remarks>
        ...
        /// <summary>Returns the length of privacyParameters USM header field. For DES, field length is 8.</summary>
        ...
        /// <summary>DES implementation does NOT support extending of a short encryption key. Always returns false.</summary>
