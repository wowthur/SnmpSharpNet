...
namespace SnmpSharpNet.Security
{
    ...
    public class MsgFlags : AsnType, ICloneable
    {
        ...
        public override int Decode(byte[] buffer, int offset)
        {
            ...
            {
                _authenticationFlag = ((flagObject[0] & FLAG_AUTH) != 0);
                _privacyFlag = ((flagObject[0] & FLAG_PRIV) != 0);
                _reportableFlag = ((flagObject[0] & FLAG_REPORTABLE) != 0);
            }
            else
        ...
        public override string ToString()
        {
            return string.Format(
                ...
                _reportableFlag.ToString(),
                _authenticationFlag.ToString(), 
                _privacyFlag.ToString()
            );
        }
    }
}
