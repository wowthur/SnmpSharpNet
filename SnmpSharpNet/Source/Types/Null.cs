...
namespace SnmpSharpNet.Types
{
    ...
    public class Null : AsnType, ICloneable
    {
        ...
        /// <summary>ASN.1 encode Null value</summary>
        /// <param name="buffer"><see cref="MutableByte"/> class to the end of which encoded data is appended</param>
        public override void Encode(MutableByte buffer)
        {
            BuildHeader(buffer, Type, 0);
        }

        /// <summary>Decode null value from BER encoded buffer.</summary>
