...
namespace SnmpSharpNet.Types
{
        ...
        IEnumerable<uint>
    {
        ...
        /// <summary> Sets the object to the passed dotted decimal object identifier string.</summary>
        ...
        /// <summary> Add uint identifiers to the current object.</summary>
        ...
        /// </summary>
        /// <param name="oids">The dotted decimal identifiers to Append</param>
        public virtual void Add(string oids)
        {
            Add(Parse(oids));
        }

        /// <summary>Appends the passed Oid object to self.</summary>
        /// <param name="second">The object to Append to self</param>
        ...
        /// <summary>Return child components of the leaf OID.</summary>
        ...
        public static uint[] GetChildIdentifiers(Oid root, Oid leaf)
        {
            ...
            return leaf.GetData().Skip(root.Length).ToArray();
        }

        /// <summary>Return a string formatted as OID value of the passed integer array</summary>
        ...
        public static string ToString(int[] vals)
        {
            ...
            return string.Join(".", vals.Select(x => x.ToString(CultureInfo.CurrentCulture)));
        }

        /// <summary>Return a string formatted as OID value of the passed integer array starting at array item startpos.</summary>
        /// <param name="vals">Array of integers</param>
        ...
        /// <summary>Add two Oid values and return the new class</summary>
        ...
        /// <summary>Add integer id to the Oid class</summary>
        ...
        /// <summary>Comparison of two Oid class values.</summary>
        ...
        /// <summary>Negative comparison of two Oid class values.</summary>
        /// <param name="oid1">First Oid class</param>
        /// <param name="oid2">Second Oid class</param>
        ...
        /// <summary>Hash value for OID value</summary>
        ...
        /// <summary>Returns an enumerator that iterates through the Oid integer collection</summary>
        ...
        /// <summary>Return instance of Oid class set to null value {0,0}</summary>
