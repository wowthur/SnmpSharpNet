...
namespace SnmpSharpNet.Types
{
        ...
        IEnumerable<byte>
    {
        ...
        /// <summary>Return string formatted hexadecimal representation of the objects value.</summary>
        ...
        /// <see cref="string"/>.
        /// </summary>
        /// <param name="obj">Object of type <see cref="OctetString"/> or <see cref="string"/> to compare against</param>
        ...
        /// <summary>Dummy override to prevent compiler warning messages.</summary>
        ...
        /// <summary>Overloading equality operator</summary>
        ...
        /// <summary>Negative equality operator</summary>
        /// <param name="str1">Source (this) string</param>
        /// <param name="str2">String to compare with</param>
        ...
        /// <summary>IComparable interface implementation. Compare class contents with contents of the byte array.</summary>
        ...
        /// <summary>IComparable interface implementation. Compare class contents against another class.</summary>
        ...
        /// <summary>Decode OctetString from the BER format. </summary>
