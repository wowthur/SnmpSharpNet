...
namespace SnmpSharpNet.Types
{
    ...
    public class Integer32 : AsnType, IComparable<Integer32>, IComparable<Int32>, ICloneable
    {
        ...
        public Integer32()
        {
            Type = SnmpConstants.SMI_INTEGER;
        }

        /// <summary>Constructor</summary>
        /// <param name="val">Class value initializer</param>
        ...
        /// <param name="second">Class value initializer</param>
        ...
        /// <summary>Constructor</summary>
        /// <param name="val">Integer value in a string format.</param>
        ...
        /// <summary>Parse an Integer32 value from a string.</summary>
        ...
        /// <summary>Get/SET internal integer value</summary>
        public int Value
        {
            get { return _value; }
            set { _value = value; }
        ...
        /// <summary>Implicit casting of Integer32 value as Int32 value</summary>
        ...
        {
            if (obj is Integer32 i32c)
                return _value.Equals(i32c.Value);

            if (obj is Int32 i32t)
                return _value.Equals(i32t);
        ...
        /// <summary>Negative comparison operator</summary>
        /// <param name="first">First <see cref="Integer32"/> class value to compare</param>
        /// <param name="second">Second <see cref="Integer32"/> class value to compare</param>
