...
{
    /// <summary>ASN.1 Gauge32 value class.</summary>
    [Serializable]
    public class Gauge32 : UInteger32, ICloneable
    {
        ...
        public Gauge32() : base()
        {
            Type = SnmpConstants.SMI_GAUGE32;
        }
        ...
        /// </summary>
        /// <param name="second">The object to recover values from.</param>
        ...
        /// </summary>
        /// <param name="val">32-bit unsigned integer encoded as a string</param>
        ...
        public Gauge32(uint val) : base(val)
        {
            Type = SnmpConstants.SMI_GAUGE32;
        }
